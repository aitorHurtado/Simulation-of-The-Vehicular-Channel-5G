...
eqHeaderData = ofdmEqualize(demodulatedHeader,estChannel(:,headerIdx-1-1));
...
if sysParam.print_allData == 1
    diagnostics.rxConstellationHeader_NoEq = demodulatedHeader(headerInd);
    diagnostics.rxConstellationData_NoEq = demodulatedData(:,headerIdx:end);
